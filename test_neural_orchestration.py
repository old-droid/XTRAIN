...
def test_neural_orchestration_system():
    ...
    try:
        ...
        print(f"✓ Neural orchestration forward pass successful")
        ...
        print("✓ All orchestration outputs and metadata verified")
        
    except Exception as e:
        print(f"✗ Neural orchestration test failed: {e}")
        return False
    
    # Test metrics
    try:
        metrics = orchestration.get_orchestration_metrics()
        print(f"✓ Orchestration metrics retrieved: {len(metrics)} metrics")
        ...
        print("✓ All orchestration metrics verified")
...
def test_integrated_chapati_lm():
    ...
    try:
        ...
        print(f"✓ ChapatiLM with neural orchestration initialized")
    ...
    try:
        ...
        print(f"✓ Test input prepared: '{test_text}'")
    ...
    try:
        ...
        print("✓ Orchestration metrics in performance analysis verified")
        ...
        print("✓ Enhanced efficiency metrics verified")
...
def test_retry_mechanism_with_orchestration():
    ...
    try:
        ...
        print("✓ Model with enhanced retry mechanism initialized")
        ...
        print(f"✓ Challenging input prepared: '{challenging_text[:50]}...'")
        ...
        print(f"✓ Forward pass with challenging input completed")
        ...
        if metrics['retry_attempts'] > 0:
            ...
            print("✓ Retry mechanism working with neural orchestration guidance")
        else:
            print("✓ No retries needed - input processed successfully on first attempt")
...
def test_safety_guardrail():
    ...
    try:
        ...
        print(f"✓ Safety guardrail test completed")
        ...
        print("✓ Safety guardrail metrics verified")
        
    except Exception as e:
        print(f"✗ Safety guardrail test failed: {e}")
        return False
...
def test_end_to_end_integration():
    ...
    try:
        ...
        print("✓ End-to-end system initialized")
...
def main():
    ...
    if passed == total:
        print("\n🎉 ALL TESTS PASSED! Neural orchestration integration successful!")
        return True
    else:
